...
$pageDataNotif = $notifUtil->supervisorNotif($currentLoggedInSupervisor->getSupervisorId(), 1, $notifSize, false);
...
<ul class="header-nav d-md-flex ms-auto">
    <li class="nav-item dropdown"><a class="nav-link" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu dropdown-menu-end dropdown-menu-lg pt-0">
            ...
            <?php 
                echo $totalNotif > 0 ? "Anda memiliki $totalNotif notifikasi" : "Tidak ada notifikasi";
            ?>
            </div>
...
$pageDataMessage = $messageUtil->supervisorInbox($currentLoggedInSupervisor->getSupervisorId(), 1, $messageSize, false);
...
?>
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end dropdown-menu-md pt-0 dropdown-message-header">
            ...
            <?php 
                echo $totalMessage > 0 ? "Anda memiliki $totalMessage pesan" : "Tidak ada pesan";
            ?>
            </div>
