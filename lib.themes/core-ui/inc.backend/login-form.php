              ...
              <div class="card col-md-7 p-4 mb-0">
                <div class="card-body">
                  <form action="login.php" method="post">
                    <h1>Login</h1>
                    <p class="text-body-secondary"><?php echo $appLanguage->getSignInToYourAccount();?></p>
                    <div class="input-group mb-3"><span class="input-group-text">
                        <svg class="icon">
                            <use xlink:href="<?php echo $baseAssetsUrl;?><?php echo $themePath;?>vendors/@coreui/icons/svg/free.svg#cil-user"></use>
                        </svg></span>
                        <input class="form-control" type="text" name="username" placeholder="<?php echo $appLanguage->getPlaceholderUsername();?>">
                    </div>
                    <div class="input-group mb-3"><span class="input-group-text">
                        <svg class="icon">
                            <use xlink:href="<?php echo $baseAssetsUrl;?><?php echo $themePath;?>vendors/@coreui/icons/svg/free.svg#cil-lock-locked"></use>
                        </svg></span>
                        <input class="form-control" type="password" name="password" placeholder="<?php echo $appLanguage->getPlaceholderPassword();?>">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                        <button class="btn btn-primary px-4" type="submit"><?php echo $appLanguage->getButtonLogin();?></button>
                        </div>
