                ...
                <div class="card-body">
                  <form action="reset-password.php" method="post">
                    ...
                    <div class="input-group mb-3"><span class="input-group-text">
                        ...
                        <input class="form-control" type="text" name="username" placeholder="<?php echo $appLanguage->getPlaceholderEmail();?>">
                    </div>
                    <div class="input-group mb-3"><span class="input-group-text">
                        <svg class="icon">
                            <use xlink:href="<?php echo $baseAssetsUrl;?><?php echo $themePath;?>vendors/@coreui/icons/svg/free.svg#cil-task"></use>
                        </svg></span>
                        <input class="form-control" type="text" name="answer" placeholder="<?php echo $appLanguage->getPlaceholderCaptcha();?>">
                    </div>
