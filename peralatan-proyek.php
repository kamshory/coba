			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="text" name="jumlah" id="jumlah"/>
						</td>
					</tr>
					<tr>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getJumlah();?></td>
						<td>
							<input class="form-control" type="text" name="jumlah" id="jumlah" value="<?php echo $peralatanProyek->getJumlah();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getProyek();?></td>
