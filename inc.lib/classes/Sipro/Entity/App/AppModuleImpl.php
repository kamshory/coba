...
class AppModuleImpl extends AppModule
{
	 ...
	 * 
	 * @NotNull
	 * @Column(name="grup_modul_id", type="varchar(40)", length=40, default_value="NULL", nullable=true)
	 ...
	 * 
	 * @NotNull
	 * @Column(name="nama", type="varchar(40)", length=40, default_value="NULL", nullable=true)
	 * @Label(content="Name")
	 * @var string
	 */
	protected $name;
	 ...
	 * 
	 * @NotNull
	 * @Column(name="istimewa", type="tinyint(1)", length=1, default_value="0", nullable=true)
	 ...
	 * 
	 * @NotNull
	 * @Column(name="aktif", type="tinyint(1)", length=1, default_value="0", nullable=true)
