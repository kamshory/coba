...
/**
 * PesanTrash is entity of table pesan_trash. You can join this entity to other entity using annotation JoinColumn. 
 * Don't forget to add "use" statement if the entity is outside the namespace.
 * Visit https://github.com/Planetbiru/MagicObject/blob/main/tutorial.md#entity
 * 
 * @Entity
 * @JSON(property-naming-strategy=SNAKE_CASE, prettify=false)
 * @Table(name="pesan_trash")
 */
class PesanTrash extends MagicObject
{
	/**
	 * Pesan Trash ID
	 * 
	 ...
	 * @Column(name="pesan_trash_id", type="varchar(40)", length=40, default_value="NULL", nullable=true)
	 * @DefaultColumn(value="NULL")
	 * @Label(content="Pesan Trash ID")
	 * @var string
	 */
	protected $pesanTrashId;

	/**
	 * Pesan ID
	 * 
	 * @NotNull
	 * @Column(name="pesan_id", type="bigint(20)", length=20, nullable=false)
