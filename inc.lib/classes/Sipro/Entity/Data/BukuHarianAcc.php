...
/**
 * BukuHarianAcc is entity of table buku_harian. You can join this entity to other entity using annotation JoinColumn. 
 ...
 */
class BukuHarianAcc extends MagicObject
{
	/**
	 * Buku Harian ID
	 * 
	 ...
	 * @JoinColumn(name="proyek_id", referenceColumnName="proyek_id")
	 * @Label(content="Proyek")
	 * @var SupervisorProyek
	 */
	protected $supervisorProyek;
