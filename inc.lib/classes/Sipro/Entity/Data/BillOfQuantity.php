...
/**
 * BillOfQuantity is entity of table bill_of_quantity. You can join this entity to other entity using annotation JoinColumn. 
 ...
 */
class BillOfQuantity extends MagicObject
{
	/**
	 * Bill Of Quantity ID
	 * 
