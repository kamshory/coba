...
/**
 * KelasTowerMin is entity of table kelas_tower. You can join this entity to other entity using annotation JoinColumn. 
 ...
 */
class KelasTowerMin extends MagicObject
{
	/**
	 * Kelas Tower ID
	 * 
