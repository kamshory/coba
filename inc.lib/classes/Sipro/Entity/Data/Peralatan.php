...
/**
 * Peralatan is entity of table peralatan. You can join this entity to other entity using annotation JoinColumn. 
 ...
 */
class Peralatan extends MagicObject
{
	/**
	 * Peralatan ID
	 * 
	 ...
	 * @NotNull
	 * @Column(name="peralatan_id", type="bigint(20)", length=20, nullable=false, extra="auto_increment")
