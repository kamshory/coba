...
$currentModule = new PicoModule($appConfig, $database, $appModule, "/admin", "cache", "Cache");
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="text" name="cache_id" id="cache_id"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getContent();?></td>
						<td>
							<input autocomplete="off" class="form-control" type="text" name="content" id="content"/>
						</td>
					</tr>
					<tr>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						<td><?php echo $appEntityLanguage->getCacheId();?></td>
						<td>
							<input class="form-control" type="text" name="app_builder_new_pk_cache_id" id="cache_id" value="<?php echo $cache->getCacheId();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getContent();?></td>
						<td>
							<input class="form-control" type="text" name="content" id="content" value="<?php echo $cache->getContent();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getExpire();?></td>
