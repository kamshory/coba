			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="text" name="user_type" id="user_type"/>
						</td>
					</tr>
					<tr>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getUserType();?></td>
						<td>
							<input class="form-control" type="text" name="user_type" id="user_type" value="<?php echo $menuCache->getUserType();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getContent();?></td>
						<td>
							<input class="form-control" type="text" name="content" id="content" value="<?php echo $menuCache->getContent();?>" autocomplete="off"/>
						</td>
					</tr>
				</tbody>
			</table>
