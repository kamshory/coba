...
if($supervisorId != 0 && !empty($periodeId))
{
    ...
    $(document).ready(function(e) {
        $(document).on('click', '#download', function(e) {
            ...
            var style = '<style type="text/css">.time-sheet{border-collapse:collapse;}.time-sheet td{padding:2px;}.time-sheet p{margin:0;padding:0;}.time-sheet img{vertical-align:bottom;}.supervisor-sign-text{white-space:nowrap;}h1{font-size:18px;text-align:center;margin:4px;padding:0}.time-sheet td table td{padding:0;}.day{text-align:center;}.weekend{background-color:#B9B9B9;}.dayoff{background-color:#F60;}.day.dayoff.weekend{background-color:#F60 !important;}.travel.dayoff{background-color:#03F !important;}.travel.weekend{background-color:#03F !important;}.travel.weekend.dayoff{background-color:#03F !important;}.travel{background-color:#03F !important;}tfoot .leave{background-color:#EE0000;}</style>';
