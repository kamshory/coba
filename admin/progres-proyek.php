			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="text" name="persen" id="persen"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="text" name="ip_ubah" id="ip_ubah"/>
						</td>
					</tr>
					<tr>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getPersen();?></td>
						<td>
							<input class="form-control" type="text" name="persen" id="persen" value="<?php echo $progresProyek->getPersen();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getWaktuBuat();?></td>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getIpBuat();?></td>
						<td>
							<input class="form-control" type="text" name="ip_buat" id="ip_buat" value="<?php echo $progresProyek->getIpBuat();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getIpUbah();?></td>
						<td>
							<input class="form-control" type="text" name="ip_ubah" id="ip_ubah" value="<?php echo $progresProyek->getIpUbah();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAktif();?></td>
		...
		<form name="detailform" id="detailform" action="" method="post">
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getWaktuBuat();?></td>
						<td><?php echo $progresProyek->getWaktuBuat();?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getWaktuUbah();?></td>
						<td><?php echo $progresProyek->getWaktuUbah();?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getSupervisorBuat();?></td>
					...
					<table class="table table-row table-sort-by-column">
						...
						<tbody data-offset="<?php echo $pageData->getDataOffset();?>">
							...
							<tr data-number="<?php echo $pageData->getDataOffset() + $dataIndex;?>">
								...
								<td data-col-name="waktu_buat"><?php echo $progresProyek->getWaktuBuat();?></td>
								<td data-col-name="waktu_ubah"><?php echo $progresProyek->getWaktuUbah();?></td>
