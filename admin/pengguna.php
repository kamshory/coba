					...
					<tr>
						...
						<td>
							<select class="form-control" name="gender_id" id="gender_id" data-value="<?php echo $user->getGenderId();?>">
								<option value=""><?php echo $appLanguage->getLabelOptionSelectOne();?></option>
								<option value="M" <?php echo AppFormBuilder::selected($user->getGenderId(), 'M');?>>Laki-Laki</option>
								<option value="W" <?php echo AppFormBuilder::selected($user->getGenderId(), 'W');?>>Perempuan</option>
							</select>
						</td>
					</tr>
					<tr>
