...
if($inputPost->getUserAction() == UserAction::CREATE)
{
	...
	$user->setGenderId($inputPost->getGenderId(PicoFilterConstant::FILTER_SANITIZE_NUMBER_INT, false, false, true));
...
{
$appEntityLanguage = new AppEntityLanguage(new User(), $appConfig, $currentUser->getLanguageId());
		...
		<form name="createform" id="createform" action="" method="post">
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getGenderId();?></td>
						<td>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						<td><?php echo $appEntityLanguage->getFirstName();?></td>
						<td>
							<input class="form-control" type="text" name="first_name" id="first_name" value="<?php echo $user->getFirstName();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getLastName();?></td>
						<td>
							<input class="form-control" type="text" name="last_name" id="last_name" value="<?php echo $user->getLastName();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getUsername();?></td>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getGenderId();?></td>
						<td>
							<select class="form-control" name="gender_id" id="gender_id" data-value="<?php echo $user->getGenderId();?>">
								<option value=""><?php echo $appLanguage->getLabelOptionSelectOne();?></option>
								<option value="1" <?php echo AppFormBuilder::selected($user->getGenderId(), '1');?>>Laki-Laki</option>
								<option value="2" <?php echo AppFormBuilder::selected($user->getGenderId(), '2');?>>Perempuan</option>
							</select>
						</td>
					</tr>
					<tr>
		...
		<form name="detailform" id="detailform" action="" method="post">
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getGenderId();?></td>
						<td><?php echo isset($mapForGenderId) && isset($mapForGenderId[$user->getGenderId()]) && isset($mapForGenderId[$user->getGenderId()]["label"]) ? $mapForGenderId[$user->getGenderId()]["label"] : "";?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getUserLevel();?></td>
...
if($inputGet->getUserAction() == UserAction::EXPORT)
{
	...
	$exporter->write($pageData, $fileName, $sheetName, array(
		...
		$appEntityLanguage->getGenderId() => $headerFormat->asString(),
	...
	function($index, $row, $appLanguage){
		...
		return array(
			...
			$row->getWebsite(),
			$row->getPhone(),
			isset($mapForGenderId) && isset($mapForGenderId[$row->getGenderId()]) && isset($mapForGenderId[$row->getGenderId()]["label"]) ? $mapForGenderId[$row->getGenderId()]["label"] : "",
			...
			<form action="" method="get" class="filter-form">
				<span class="filter-group">
					...
					<span class="filter-control">
						<input type="text" name="first_name" class="form-control" value="<?php echo $inputGet->getFirstName();?>" autocomplete="off"/>
					</span>
				</span>
				...
				<span class="filter-group">
					<span class="filter-label"><?php echo $appEntityLanguage->getGenderId();?></span>
					<span class="filter-control">
							<select name="gender_id" class="form-control" data-value="<?php echo $inputGet->getGenderId();?>">
								<option value=""><?php echo $appLanguage->getLabelOptionSelectOne();?></option>
								<option value="M" <?php echo AppFormBuilder::selected($inputGet->getGenderId(), 'M');?>>Laki-Laki</option>
								<option value="W" <?php echo AppFormBuilder::selected($inputGet->getGenderId(), 'W');?>>Perempuan</option>
							</select>
					</span>
				</span>
					...
					<table class="table table-row table-sort-by-column">
						<thead>
							<tr>
								...
								<td data-col-name="first_name" class="order-controll"><a href="#"><?php echo $appEntityLanguage->getFirstName();?></a></td>
								<td data-col-name="last_name" class="order-controll"><a href="#"><?php echo $appEntityLanguage->getLastName();?></a></td>
								...
								<td data-col-name="gender_id" class="order-controll"><a href="#"><?php echo $appEntityLanguage->getGenderId();?></a></td>
						...
						<tbody data-offset="<?php echo $pageData->getDataOffset();?>">
							...
							<tr data-number="<?php echo $pageData->getDataOffset() + $dataIndex;?>">
								...
								<td data-col-name="first_name"><?php echo $user->getFirstName();?></td>
								<td data-col-name="last_name"><?php echo $user->getLastName();?></td>
								<td data-col-name="username"><?php echo $user->getUsername();?></td>
								<td data-col-name="phone"><?php echo $user->getPhone();?></td>
								<td data-col-name="gender_id"><?php echo isset($mapForGenderId) && isset($mapForGenderId[$user->getGenderId()]) && isset($mapForGenderId[$user->getGenderId()]["label"]) ? $mapForGenderId[$user->getGenderId()]["label"] : "";?></td>
								...
								<td data-col-name="blocked"><?php echo $user->optionBlocked($appLanguage->getYes(), $appLanguage->getNo());?></td>
