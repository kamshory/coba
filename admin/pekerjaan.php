...
$currentModule = new PicoModule($appConfig, $database, $appModule, "/admin", "pekerjaan", "Pekerjaan");
...
else if($inputPost->getUserAction() == UserAction::UPDATE)
{
	...
	$specification = PicoSpecification::getInstance()->addAnd(new PicoPredicate(Field::of()->pekerjaanId, $inputPost->getPekerjaanId()));
	$pekerjaan = new Pekerjaan(null, $database);
	$pekerjaan->where($specification)->setPekerjaanId($inputPost->getAppBuilderNewPkPekerjaanId())->update();
						...
						<td>
							<select class="form-control" name="jenis_pekerjaan_id" id="jenis_pekerjaan_id">
								...
								PicoSortable::getInstance()
									->add(new PicoSort(Field::of()->sortOrder, PicoSort::ORDER_TYPE_ASC))
									->add(new PicoSort(Field::of()->nama, PicoSort::ORDER_TYPE_ASC)), 
								Field::of()->jenisPekerjaanId, Field::of()->nama, null, array(Field::of()->kelasPondasiId, Field::of()->tipeTowerId, Field::of()->jenisPekerjaanId))
								; ?>
							</select>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<select class="form-control" name="buku_harian_id" id="buku_harian_id">
								...
								PicoSortable::getInstance()
									->add(new PicoSort(Field::of()->tanggal, PicoSort::ORDER_TYPE_DESC)), 
								Field::of()->bukuHarianId, Field::of()->tanggal, $pekerjaan->getBukuHarianId())
								; ?>
							</select>
						</td>
					</tr>
						...
						<td>
							<select class="form-control" name="jenis_pekerjaan_id" id="jenis_pekerjaan_id">
								...
								PicoSortable::getInstance()
									->add(new PicoSort(Field::of()->sortOrder, PicoSort::ORDER_TYPE_ASC))
									->add(new PicoSort(Field::of()->nama, PicoSort::ORDER_TYPE_ASC)), 
								Field::of()->jenisPekerjaanId, Field::of()->nama, $pekerjaan->getJenisPekerjaanId(), array(Field::of()->kelasPondasiId, Field::of()->tipeTowerId, Field::of()->jenisPekerjaanId))
								; ?>
							</select>
						</td>
					</tr>
		...
		<form name="detailform" id="detailform" action="" method="post">
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getBukuHarian();?></td>
						<td><?php echo $pekerjaan->hasValueBukuHarian() ? $pekerjaan->getBukuHarian()->getTanggal() : "";?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getSupervisor();?></td>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getKelasTower();?></td>
						<td><?php echo $pekerjaan->hasValueKelasTower() ? $pekerjaan->getKelasTower()->getNama() : "";?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getLatitude();?></td>
					...
					<table class="table table-row table-sort-by-column">
						...
						<tbody data-offset="<?php echo $pageData->getDataOffset();?>">
							...
							<tr data-number="<?php echo $pageData->getDataOffset() + $dataIndex;?>">
								...
								<td data-col-name="buku_harian_id"><?php echo $pekerjaan->hasValueBukuHarian() ? $pekerjaan->getBukuHarian()->getTanggal() : "";?></td>
								...
								<td data-col-name="kelas_tower_id"><?php echo $pekerjaan->hasValueKelasTower() ? $pekerjaan->getKelasTower()->getNama() : "";?></td>
