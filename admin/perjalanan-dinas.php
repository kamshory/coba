...
$currentModule = new PicoModule($appConfig, $database, $appModule, "/admin", "perjalanan-dinas", "Perjalanan Dinas");
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="text" name="nomor_sppd" id="nomor_sppd"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAsal();?></td>
						<td>
							<input autocomplete="off" class="form-control" type="text" name="asal" id="asal"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getTujuan();?></td>
						<td>
							<input autocomplete="off" class="form-control" type="text" name="tujuan" id="tujuan"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="text" name="atas_beban_biaya" id="atas_beban_biaya"/>
						</td>
					</tr>
					<tr>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getNomorSppd();?></td>
						<td>
							<input class="form-control" type="text" name="nomor_sppd" id="nomor_sppd" value="<?php echo $perjalananDinas->getNomorSppd();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAsal();?></td>
						<td>
							<input class="form-control" type="text" name="asal" id="asal" value="<?php echo $perjalananDinas->getAsal();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getTujuan();?></td>
						<td>
							<input class="form-control" type="text" name="tujuan" id="tujuan" value="<?php echo $perjalananDinas->getTujuan();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getKodeLokasi();?></td>
						<td>
							<input class="form-control" type="text" name="kode_lokasi" id="kode_lokasi" value="<?php echo $perjalananDinas->getKodeLokasi();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAlatAngkutan();?></td>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getAtasBebanBiaya();?></td>
						<td>
							<input class="form-control" type="text" name="atas_beban_biaya" id="atas_beban_biaya" value="<?php echo $perjalananDinas->getAtasBebanBiaya();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getDibayar();?></td>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td><?php echo $perjalananDinas->getWaktuUbah();?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><?php echo $perjalananDinas->hasValuePembuat() ? $perjalananDinas->getPembuat()->getFirstName() : "";?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAdminUbah();?></td>
						<td><?php echo $perjalananDinas->hasValuePengubah() ? $perjalananDinas->getPengubah()->getFirstName() : "";?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAktif();?></td>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						<td></td>
						<td>
							<?php if($inputGet->getNextAction() == UserAction::APPROVAL && UserAction::isRequireApproval($perjalananDinas->getWaitingFor()) && $userPermission->isAllowedApprove()){ ?>
							...
							<?php } else if($inputGet->getNextAction() == UserAction::APPROVE && UserAction::isRequireApproval($perjalananDinas->getWaitingFor()) && $userPermission->isAllowedApprove()){ ?>
							<button type="submit" class="btn btn-success" name="user_action" value="<?php echo UserAction::APPROVE;?>"><?php echo $appLanguage->getButtonApprove();?></button>
...
if($inputGet->getUserAction() == UserAction::EXPORT)
{
	...
	$exporter->write($pageData, $fileName, $sheetName, array(
		...
		$appEntityLanguage->getPerjalananDinasId() => $headerFormat->getPerjalananDinasId(),
	...
	function($index, $row, $appLanguage){
		...
		return array(
			sprintf("%d", $index + 1),
			$row->getPerjalananDinasId(),
			$row->hasValueJenisPerjalananDinas() ? $row->getJenisPerjalananDinas()->getNama() : "",
