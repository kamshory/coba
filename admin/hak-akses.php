...
$currentModule = new PicoModule($appConfig, $database, $appModule, "/admin", "pengaturan-hak-akses", "Pengaturan Hak Akses");
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getKodeModul();?></td>
						<td>
							<input class="form-control" type="text" name="kode_modul" id="kode_modul" value="<?php echo $hakAkses->getKodeModul();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAllowedList();?></td>
