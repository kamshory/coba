	...
	<div class="jambi-wrapper">
		<form name="detailform" id="detailform" action="" method="post">
			...
			<div class="button-area">
				...
				<button type="button" id="pdf" class="btn btn-primary" onclick="window.open('buku-harian-pdf.php?buku_harian_id=<?php echo $bukuHarianId;?>')" >Print PDF</button>
				<button type="button" id="showall" class="btn btn-secondary" onclick="window.location='<?php echo basename($_SERVER['PHP_SELF']);?>'" >Tampilkan Semua</button>
			</div>
		</form>
	</div>
</div>
