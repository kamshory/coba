...
$currentModule = new PicoModule($appConfig, $database, $appModule, "/admin", "tsk", "Tsk");
...
else if($inputPost->getUserAction() == UserAction::ACTIVATE)
{
	if($inputPost->countableCheckedRowId())
	{
		...
		{
			$tsk = new Tsk(null, $database);
			$tsk->setTskId($rowId)->setAktif(true)->update();
		}
	}
...
else if($inputPost->getUserAction() == UserAction::DEACTIVATE)
{
	if($inputPost->countableCheckedRowId())
	{
		...
		{
			$tsk = new Tsk(null, $database);
			$tsk->setTskId($rowId)->setAktif(false)->update();
		}
	}
	$currentModule->redirectToItself();
}
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="text" name="provinsi" id="provinsi"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getKabupaten();?></td>
						<td>
							<input autocomplete="off" class="form-control" type="text" name="kabupaten" id="kabupaten"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getKecamatan();?></td>
						<td>
							<input autocomplete="off" class="form-control" type="text" name="kecamatan" id="kecamatan"/>
						</td>
					</tr>
					<tr>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						<td><?php echo $appEntityLanguage->getNama();?></td>
						<td>
							<input class="form-control" type="text" name="nama" id="nama" value="<?php echo $tsk->getNama();?>" autocomplete="off" required="required"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getUmk();?></td>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getProvinsi();?></td>
						<td>
							<input class="form-control" type="text" name="provinsi" id="provinsi" value="<?php echo $tsk->getProvinsi();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getKabupaten();?></td>
						<td>
							<input class="form-control" type="text" name="kabupaten" id="kabupaten" value="<?php echo $tsk->getKabupaten();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getKecamatan();?></td>
						<td>
							<input class="form-control" type="text" name="kecamatan" id="kecamatan" value="<?php echo $tsk->getKecamatan();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAktif();?></td>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td><?php echo $tsk->getWaktuBuat();?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getWaktuUbah();?></td>
						<td><?php echo $tsk->getWaktuUbah();?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><?php echo $tsk->hasValuePembuat() ? $tsk->getPembuat()->getFirstName() : "";?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAdminUbah();?></td>
						<td><?php echo $tsk->hasValuePengubah() ? $tsk->getPengubah()->getFirstName() : "";?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAktif();?></td>
