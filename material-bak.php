...
$currentModule = new PicoModule($appConfig, $database, $appModule, "/", "material", "Material");
...
// $specification->addAnd(PicoPredicate::getInstance()->equals('supervisorId', $currentUser->getSupervisorId()));
