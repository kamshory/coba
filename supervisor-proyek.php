...
$currentModule = new PicoModule($appConfig, $database, $appModule, "/", "supervisor-proyek", "Supervisor Proyek");
		...
		foreach($inputPost->getCheckedRowId() as $rowId)
		{
			...
			try
			{
				$supervisorProyek->where(PicoSpecification::getInstance()
					->addAnd(PicoPredicate::getInstance()->equals(Field::of()->supervisor_proyek_id, $rowId))
