...
$currentModule = new PicoModule($appConfig, $database, $appModule, "/", "cuti", "Cuti");
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						<td></td>
						<td>
							<?php if($inputGet->getNextAction() == UserAction::APPROVE && UserAction::isRequireApproval($cuti->getWaitingFor()) && $userPermission->isAllowedApprove()){ ?>
